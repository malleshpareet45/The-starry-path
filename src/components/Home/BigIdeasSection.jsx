    ...
    return (
        <section className="section big-ideas-section">
            ...
            <div className="big-ideas-cta flex justify-center px-4" data-aos="fade-up" data-aos-delay="200">
                <button
                    className="btn-join uppercase text-sm md:text-2xl px-6 py-3 md:px-12 md:py-4 w-full md:w-auto rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
